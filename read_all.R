...
unempl_and_income  <- read.csv("clean_data/Unemployment_naomit_2010onwards.csv")
...
# voting <- read.csv("/home/aiden/Documents/School/STAT333/Project/data/voting_data_2016.csv")

# add fips to voting data
...
plot_usmap(data = data2, values = "regular", color = "grey", size = .25) +
